...
[AddComponentMenu ("Image Effects/Camera/Depth of Field (3.4f)")]
...
public class DepthOfField34 : PostEffectsBase
{
	...
	{	
		...
		if (bokeh && ((bokehDestination != null) & (bokehDestination == BokehDestination.Background)))
		{ 		
		...
		{			
			...
			Downsample (source, mediumRezWorkTexture);	
	 		...
	 		if (bokeh && ((bokehDestination != null) & (bokehDestination == BokehDestination.Foreground)))
			{ 
